...
let s:N1 = [ '#ffffff' , '#005252' , 4 , 232]
let s:N2 = [ '#ffffff' , '#003f3f' , 5 , 232 ]
let s:N3 = [ '#ffffff' , '#002b2b' , 2 , 232 ]
...
let g:airline#themes#railscasts#palette.normal_modified = {
      \ 'airline_c': [ '#ffffff' , '#450000' , 232     , 1      , ''     ] ,
      \ }


let s:I1 = [ '#ffffff' , '#789f00' , 3 , 232 ]
let s:I2 = [ '#ffffff' , '#003f3f' , 5 , 232  ]
let s:I3 = [ '#ffffff' , '#002b2b' , 2 , 232  ]
...
let s:V1 = [ '#ffff9a' , '#ff8036' , 6 , 232 ]
let s:V2 = [ '#ffffff' , '#003f3f' , 5 , 232 ]
let s:V3 = [ '#ffffff' , '#002b2b' , 2 , 232 ]
...
let g:airline#themes#railscasts#palette.tabline = {
      \ 'airline_tab':  ['#2aa198', '#003f3f',  232, 4, ''],
      \ 'airline_tabsel':  ['#ffffff', '#2e8b57',  4, 232, ''],
      \ 'airline_tabtype':  ['#ffffff', '#005252',  4, 232, ''],
      \ 'airline_tabfill':  ['#ffffff', '#002b2b',  4, 232, ''],
      \ 'airline_tabmod':  ['#ffffff', '#780000',  1, 232, ''],
      \ }

let s:WI = [ '#ffffff', '#5f0000', 2, 232 ]
